...
export const ComponentSchema = z.discriminatedUnion("type", [
  ...
  z.object({
    ...
    interactions: z.array(z.object({
      ...
      requireCorrectToContinue: z.boolean().default(true),
  ...
  z.object({
    ...
    frontBorder: z.string().optional(),
    frontShadow: z.string().optional(),
    backBackground: z.string().optional(),
    backBorder: z.string().optional(),
    backShadow: z.string().optional(),
    frontBadgeColor: z.string().optional(),
    backBadgeColor: z.string().optional(),
