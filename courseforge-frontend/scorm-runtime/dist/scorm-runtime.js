...
`)+`
`+p);const b=S+m+a,x=S+p+o,C=Ca(r,r.VERTEX_SHADER,b),A=Ca(r,r.FRAGMENT_SHADER,x);r.attachShader(_,C),r.attachShader(_,A),n.index0AttributeName!==void 0?r.bindAttribLocation(_,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function w(R){if(e.debug.checkShaderErrors){const H=r.getProgramInfoLog(_)||"",W=r.getShaderInfoLog(C)||"",z=r.getShaderInfoLog(A)||"",k=H.trim(),G=W.trim(),I=z.trim();let Y=!0,J=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(Y=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(r,_,C,A);else{const te=Pa(r,C,"vertex"),fe=Pa(r,A,"fragment");we("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,t.onmouseover=()=>t.style.background="#8b1a1a",t.onmouseout=()=>t.style.background="#c0392b",t.addEventListener("click",()=>{this.bgAudioElement&&this.bgAudioElement.play().catch(i=>console.warn("Still blocked after interaction:",i)),e.remove()}),e.appendChild(t);const n=document.createElement("p");n.textContent="Your browser requires you to click before audio can play.",n.style.cssText="margin-top: 16px; font-size: 14px; color: #a1a1aa;",e.appendChild(n),document.body.appendChild(e)}renderSlide(e){const t=this.course.slides[e];if(!t)return;const n=document.getElementById("cf-slide-container");if(!n)return;const i=t.background;i?i.type==="color"&&i.value?(n.style.backgroundColor=i.value,n.style.backgroundImage="none"):i.type==="image"&&i.value&&(n.style.backgroundColor="#18181b",n.style.backgroundImage=`url("${i.value}")`,n.style.backgroundSize="cover",n.style.backgroundPosition="center"):(n.style.backgroundColor="#18181b",n.style.backgroundImage="none");const r=t.bgAudio,s=r?r.src||r.url:null,a=()=>{this.bgAudioElement&&this.bgAudioElement.play().catch(o=>{console.warn("Background audio play blocked:",o),o.name==="NotAllowedError"&&this.showAudioUnlockOverlay()})};if(s){this.bgAudioElement||(this.bgAudioElement=document.createElement("audio"),this.bgAudioElement.loop=!0);const o=new URL(s,window.location.href).href;this.bgAudioElement.src!==o&&(this.bgAudioElement.pause(),this.bgAudioElement.src=o,this.bgAudioElement.currentTime=0)}else this.bgAudioElement&&(this.bgAudioElement.pause(),this.bgAudioElement.removeAttribute("src"),this.bgAudioElement.load());this.bgAudioPausedByMedia=!1,this.bgAudioElement&&this.bgAudioElement.src&&a(),n.innerHTML="";for(const o of t.layers){const c=document.createElement("div");c.className="cf-rt-layer",c.id=`layer-${o.id}`,c.dataset.layerId=o.id;const l=this.state.layerVisibility[o.id]??o.visible;c.style.display=l?"block":"none";for(const u of o.components){const h=this.renderComponent(u);h&&c.appendChild(h)}n.appendChild(c)}this.updateNavUI(e)}getEmbeddableVideoSrc(e,t){if(!e||t!=="youtube"&&t!=="vimeo")return e;try{const n=new URL(e,window.location.href),i=n.hostname.replace(/^www\./,"").toLowerCase(),r=n.pathname.replace(/^\/+/,"");if(t==="youtube"){let s="";if(i==="youtu.be"?s=r.split("/")[0]:r==="watch"?s=n.searchParams.get("v")||"":(r.startsWith("embed/")||r.startsWith("shorts/")||r.startsWith("live/"))&&(s=r.split("/")[1]||""),/^[A-Za-z0-9_-]{11}$/.test(s))return`https://www.youtube.com/embed/${s}?rel=0`}if(t==="vimeo"){const s=r.match(/\d+/);if(s)return`https://player.vimeo.com/video/${s[0]}`}}catch{return e}return e}getAnimationFrames(e){switch(e){case"fade-in":return[{opacity:0},{opacity:1}];case"fade-in-up":return[{opacity:0,transform:"translateY(20px)"},{opacity:1,transform:"translateY(0)"}];case"slide-in-left":return[{opacity:0,transform:"translateX(-30px)"},{opacity:1,transform:"translateX(0)"}];case"slide-in-right":return[{opacity:0,transform:"translateX(30px)"},{opacity:1,transform:"translateX(0)"}];case"slide-in-up":return[{opacity:0,transform:"translateY(30px)"},{opacity:1,transform:"translateY(0)"}];case"slide-in-down":return[{opacity:0,transform:"translateY(-30px)"},{opacity:1,transform:"translateY(0)"}];case"zoom-in":return[{opacity:0,transform:"scale(0.95)"},{opacity:1,transform:"scale(1)"}];case"zoom-out":return[{opacity:0,transform:"scale(1.05)"},{opacity:1,transform:"scale(1)"}];case"flip-in":return[{opacity:0,transform:"perspective(400px) rotateX(90deg)"},{opacity:1,transform:"perspective(400px) rotateX(0deg)"}];case"bounce-in":return[{opacity:0,transform:"scale(0.3)"},{opacity:1,transform:"scale(1.05)",offset:.5},{opacity:1,transform:"scale(0.9)",offset:.7},{opacity:1,transform:"scale(1)"}];default:return null}}applyComponentAnimation(e,t,n){if(!t||t==="none"){e.style.opacity="1";return}const i=this.getAnimationFrames(t);if(!i){e.style.opacity="1";return}const r=Math.max(0,n||0)*1e3;e.style.opacity="0",requestAnimationFrame(()=>{if(typeof e.animate=="function"){const s=e.animate(i,{duration:600,delay:r,easing:"ease-out",fill:"forwards"});s.onfinish=()=>{e.style.opacity="1"},s.oncancel=()=>{e.style.opacity="1"}}else e.style.animationDelay=`${n||0}s`,e.classList.add(`animate-${t}`),setTimeout(()=>{e.style.opacity="1"},r+650)})}renderComponent(e){const t=document.createElement("div"),n=e.animation||"none";t.className="cf-rt-component",t.id=`comp-${e.id}`;const i=e.animationDelay||0,r=e.blockFormat;if(r){if(r.bgColor&&r.bgColor!=="none"){const s=r.bgOpacity!==void 0?r.bgOpacity:1,a=r.bgColor.replace("#",""),o=parseInt(a.substring(0,2),16),c=parseInt(a.substring(2,4),16),l=parseInt(a.substring(4,6),16);t.style.background=`rgba(${o},${c},${l},${s})`}r.bgImage&&(t.style.backgroundImage=`url('${r.bgImage}')`,t.style.backgroundSize=r.bgImageSize||"cover",t.style.backgroundPosition="center",t.style.backgroundRepeat="no-repeat"),(r.paddingV!==void 0||r.paddingH!==void 0)&&(t.style.padding=`${r.paddingV??10}px ${r.paddingH??12}px`),r.borderRadius!==void 0&&(t.style.borderRadius=`${r.borderRadius}px`),r.borderWidth&&r.borderWidth>0&&(t.style.border=`${r.borderWidth}px solid ${r.borderColor||"#e8c8c8"}`),r.width&&r.width!=="100%"&&(t.style.width=r.width,t.style.marginLeft="auto",t.style.marginRight="auto"),r.minHeight&&r.minHeight>0&&(t.style.minHeight=`${r.minHeight}px`)}switch(e.type){case"text":{const s=document.createElement("div");s.className="cf-rt-text",s.innerHTML=e.content,t.appendChild(s);break}case"heading":{const s=`h${e.level||2}`,a=document.createElement(s);a.className="cf-rt-heading",a.innerHTML=e.content,t.appendChild(a);break}case"image":{t.style.textAlign="center";const s=document.createElement("img");if(s.className="cf-rt-image",s.src=e.src,s.alt=e.alt||"",s.loading="lazy",s.style.width=e.width||"100%",t.appendChild(s),e.caption){const a=document.createElement("div");a.style.marginTop="8px",a.style.fontSize="14px",a.style.color="#a1a1aa",a.textContent=e.caption,t.appendChild(a)}break}case"image-hotspot":{t.style.position="relative",t.style.display="inline-block",t.style.width="100%";const s=document.createElement("img");s.src=e.src,s.style.width="100%",s.style.borderRadius="8px",s.style.display="block",t.appendChild(s);let a=null,o=null;const c=()=>{o&&(o.remove(),o=null),a=null};(e.hotspots||[]).forEach(l=>{const u=document.createElement("div");u.style.position="absolute",u.style.left=`${l.x}%`,u.style.top=`${l.y}%`,u.style.width="24px",u.style.height="24px",u.style.backgroundColor="#b91c1c",u.style.borderRadius="50%",u.style.border="2px solid white",u.style.transform="translate(-50%, -50%)",u.style.cursor="pointer",u.style.zIndex="10",u.onclick=h=>{if(h.stopPropagation(),a===l.id)c();else{c(),a=l.id,o=document.createElement("div"),o.style.position="absolute",o.style.top=`${l.y}%`,o.style.left=`${l.x}%`,o.style.transform=`translate(${l.x>50?"-105%":"5%"}, ${l.y>50?"-105%":"5%"})`,o.style.background=l.popupColor||"#000",o.style.border="1px solid #404040",o.style.color="#fff",o.style.padding="1rem",o.style.borderRadius="6px",o.style.zIndex="50",o.style.minWidth="250px",o.style.maxWidth="300px";const d=document.createElement("div");d.style.display="flex",d.style.justifyContent="space-between",d.style.alignItems="center",d.style.marginBottom="0.5rem";const f=document.createElement("h4");f.style.margin="0",f.style.fontSize="1.1rem",f.textContent=l.title;const g=document.createElement("button");g.textContent="X",g.style.background="transparent",g.style.border="none",g.style.color="#a3a3a3",g.style.cursor="pointer",g.onclick=c,d.appendChild(f),d.appendChild(g);const _=document.createElement("p");_.style.margin="0",_.style.fontSize="0.9rem",_.style.lineHeight="1.5",_.textContent=l.content,o.appendChild(d),o.appendChild(_),t.appendChild(o)}},t.appendChild(u)});break}case"360-image-hotspot":{t.style.position="relative",t.style.display="block",t.style.width="100%",t.style.borderRadius="8px",t.style.overflow="hidden";const s=document.createElement("div");s.style.width="100%",s.style.height="400px",s.style.position="relative",s.style.background="#000000",s.style.cursor="grab",t.appendChild(s);const a=document.createElement("button");a.type="button",a.style.position="absolute",a.style.top="12px",a.style.right="12px",a.style.background="rgba(0,0,0,0.6)",a.style.border="1px solid rgba(255,255,255,0.15)",a.style.color="#fff",a.style.borderRadius="4px",a.style.width="32px",a.style.height="32px",a.style.cursor="pointer",a.style.zIndex="30",a.style.display="flex",a.style.alignItems="center",a.style.justifyContent="center",a.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path></svg>',s.appendChild(a);let o=0,c=!1,l=0,u=0;a.onclick=I=>{I.stopPropagation(),o=0};const h=new Ul,d=new It(75,1,1,1100),f=new zu({antialias:!0,alpha:!0});f.setPixelRatio(Math.min(window.devicePixelRatio,2)),f.setSize(800,400),s.appendChild(f.domElement);const g=new $l(500,60,40);g.scale(-1,1,1);const _=new zr({color:2236962,side:2}),m=new Ht(g,_);h.add(m);const p=new hc,S=e.src||e.imageUrl||"";S&&p.load(S,I=>{_.color.setHex(16777215),_.map=I,_.needsUpdate=!0});const b=I=>{c=!0,l=I.clientX,I.clientY,u=o,s.style.cursor="grabbing"},x=I=>{if(!c)return;const Y=I.clientX-l;o=u-Y*.15},C=()=>{c=!1,s.style.cursor="grab"};s.addEventListener("mousedown",b),window.addEventListener("mousemove",x),window.addEventListener("mouseup",C);const A=I=>{I.touches.length===1&&(c=!0,l=I.touches[0].clientX,I.touches[0].clientY,u=o)},w=I=>{if(!c||I.touches.length!==1)return;const Y=I.touches[0].clientX-l;o=u-Y*.2};s.addEventListener("touchstart",A),window.addEventListener("touchmove",w,{passive:!0}),window.addEventListener("touchend",C);let v=null,E=null;const X=()=>{E&&(E.remove(),E=null),v=null};let R;const H=e.hotspots||[],W={};H.forEach(I=>{const Y=document.createElement("button");Y.type="button",Y.setAttribute("aria-label",I.title||"Hotspot"),Y.style.position="absolute",Y.style.width="24px",Y.style.height="24px",Y.style.backgroundColor=I.popupColor||"#b91c1c",Y.style.borderRadius="50%",Y.style.border="2px solid white",Y.style.transform="translate(-50%, -50%)",Y.style.cursor="pointer",Y.style.zIndex="20",Y.style.padding="0",Y.style.display="none",Y.onclick=J=>{if(J.stopPropagation(),v===I.id){X();return}X(),v=I.id,E=document.createElement("div"),E.style.position="absolute",E.style.bottom="16px",E.style.left="50%",E.style.transform="translateX(-50%)",E.style.minWidth="260px",E.style.maxWidth="340px",E.style.background=I.popupColor||"#000000",E.style.border="1px solid rgba(255,255,255,0.15)",E.style.color="#fff",E.style.padding="12px 16px",E.style.borderRadius="6px",E.style.zIndex="40",E.style.boxShadow="0 8px 24px rgba(0,0,0,0.4)";const te=document.createElement("div");te.style.display="flex",te.style.justifyContent="space-between",te.style.alignItems="center",te.style.marginBottom="0.4rem";const fe=document.createElement("h4");fe.style.margin="0",fe.style.fontSize="0.95rem",fe.style.fontWeight="bold",fe.textContent=I.title||"Hotspot";const me=document.createElement("button");me.type="button",me.innerHTML="&times;",me.style.background="transparent",me.style.border="none",me.style.color="#a3a3a3",me.style.fontSize="18px",me.style.cursor="pointer",me.onclick=X,te.appendChild(fe),te.appendChild(me);const Le=document.createElement("p");Le.style.margin="0",Le.style.fontSize="0.8rem",Le.style.opacity="0.85",Le.style.lineHeight="1.45",Le.style.whiteSpace="pre-wrap",Le.textContent=I.content||"",E.appendChild(te),E.appendChild(Le),s.appendChild(E)},s.appendChild(Y),W[I.id]=Y});const z=()=>{R=requestAnimationFrame(z);const I=Ri.degToRad(90),Y=Ri.degToRad(o),J=new B;J.x=Math.sin(I)*Math.cos(Y),J.y=Math.cos(I),J.z=Math.sin(I)*Math.sin(Y),d.lookAt(J),f.render(h,d);const te=s.clientWidth,fe=400;H.forEach(me=>{const Le=W[me.id];if(!Le)return;const Fe=Ri.degToRad(90-me.pitch),q=Ri.degToRad(me.yaw),ie=new B;if(ie.x=Math.sin(Fe)*Math.cos(q),ie.y=Math.cos(Fe),ie.z=Math.sin(Fe)*Math.sin(q),ie.multiplyScalar(500),ie.project(d),ie.z>1)Le.style.display="none";else{Le.style.display="block";const ye=(ie.x*.5+.5)*te,ue=(ie.y*-.5+.5)*fe;Le.style.left=`${ye}px`,Le.style.top=`${ue}px`}})};z();const k=new ResizeObserver(I=>{for(const Y of I){const J=Y.contentRect.width||s.clientWidth;J>0&&(d.aspect=J/400,d.updateProjectionMatrix(),f.setSize(J,400))}});k.observe(s);const G=new MutationObserver(()=>{document.body.contains(s)||(cancelAnimationFrame(R),k.disconnect(),window.removeEventListener("mousemove",x),window.removeEventListener("mouseup",C),window.removeEventListener("touchmove",w),window.removeEventListener("touchend",C),g.dispose(),_.map&&_.map.dispose(),_.dispose(),f.dispose(),G.disconnect())});G.observe(document.body,{childList:!0,subtree:!0});break}case"canvas":{const s=document.createElement("div");s.style.position="relative",s.style.width="100%",s.style.minHeight="420px",s.style.aspectRatio="16 / 10",s.style.overflow="hidden",s.style.borderRadius="12px",s.style.background=e.canvasBg||"#ffffff",s.style.boxShadow="inset 0 0 0 1px rgba(17,24,39,0.06)";const a=new ResizeObserver(o=>{if(!s.isConnected){a.disconnect();return}for(const c of o){const l=(c.contentRect.width||s.clientWidth)/1e3;s.style.setProperty("--canvas-scale",String(l))}});a.observe(s),[...e.items||[]].sort((o,c)=>(o.zIndex||0)-(c.zIndex||0)).forEach(o=>{const c=document.createElement("div");if(c.style.position="absolute",c.style.left=`${o.x}%`,c.style.top=`${o.y}%`,c.style.width=`${o.w}%`,c.style.height=`${o.h}%`,c.style.zIndex=String(o.zIndex||0),c.style.boxSizing="border-box",c.style.pointerEvents="none",c.style.transform=`rotate(${o.rotation||0}deg)`,c.style.transformOrigin="50% 50%",o.type==="rect"||o.type==="circle"){const u=document.createElement("div");u.style.width="100%",u.style.height="100%",u.style.background=o.color||"#3b82f6",u.style.borderRadius=o.type==="circle"?"50%":"4px",u.style.boxShadow="0 4px 10px rgba(17, 24, 39, 0.15), 0 1px 4px rgba(17, 24, 39, 0.08)",u.style.border="1px solid rgba(17, 24, 39, 0.08)",u.style.boxSizing="border-box",c.appendChild(u)}else if(o.type==="triangle"){const u=document.createElementNS("http://www.w3.org/2000/svg","svg");u.setAttribute("viewBox","0 0 100 100"),u.setAttribute("preserveAspectRatio","none"),u.setAttribute("width","100%"),u.setAttribute("height","100%"),u.style.display="block",u.style.filter="drop-shadow(0px 4px 6px rgba(17,24,39,0.15)) drop-shadow(0px 1px 3px rgba(17,24,39,0.08))";const h=document.createElementNS("http://www.w3.org/2000/svg","polygon");h.setAttribute("points","50,0 100,100 0,100"),h.setAttribute("fill",o.color||"#3b82f6"),u.appendChild(h),c.appendChild(u)}else if(o.type==="image"){const u=document.createElement("img");u.style.width="100%",u.style.height="100%",u.style.objectFit="contain",u.src=o.src||"",u.alt="Canvas element",c.appendChild(u)}else if(o.type==="text"){c.style.height="auto";const u=document.createElement("div");u.style.width="100%",u.style.height="auto",u.style.color=o.color||"#111827",u.style.fontSize=`calc(var(--canvas-scale, 1) * ${o.fontSize||16}px)`,u.style.fontFamily=o.fontFamily||"inherit",u.style.fontWeight=o.fontWeight||"normal",u.style.fontStyle=o.fontStyle||"normal",u.style.textDecoration=o.textDecoration||"none",u.style.textAlign=o.textAlign||"left",u.style.lineHeight=String(o.lineHeight||1.5),u.style.letterSpacing=`calc(var(--canvas-scale, 1) * ${o.letterSpacing||0}px)`,u.style.whiteSpace="pre-wrap",u.style.wordBreak="break-word",u.style.background="transparent",u.style.border="none",u.style.padding="0",u.style.margin="0",u.textContent=o.text||"",c.appendChild(u)}const l=c.firstElementChild;l&&this.applyComponentAnimation(l,o.animation||"none",o.animationDelay||0),s.appendChild(c)}),t.appendChild(s);break}case"scenario":{const s=Array.isArray(e.slides)?e.slides:[],a=s.filter(f=>!f.isErrorSlide),o=a.length>0?a:[{id:`${e.id}-scene-1`,isErrorSlide:!1,imageSrc:"",dialogues:[]}],c=s.find(f=>f.isErrorSlide)??{id:`${e.id}-error`,isErrorSlide:!0,imageSrc:"",dialogues:[{id:`${e.id}-restart`,text:"Try again",x:50,y:75,action:"restart"}]},l=[...o,c];let u=0;const h={next:{interactive:!0},error:{interactive:!0},restart:{interactive:!0},static:{interactive:!1}},d=()=>{t.innerHTML="";const f=l[u],g=!!f?.isErrorSlide,_=document.createElement("div");_.style.background="#0f0f0f",_.style.border=`1px solid ${g?"#7f1d1d":"#991b1b"}`,_.style.borderRadius="12px",_.style.overflow="hidden",_.style.boxShadow="0 24px 50px rgba(0,0,0,0.22)";const m=document.createElement("div");m.style.display="flex",m.style.alignItems="center",m.style.justifyContent="space-between",m.style.gap="12px",m.style.padding="12px 16px",m.style.background="#171717",m.style.borderBottom="1px solid #262626";const p=document.createElement("div");p.style.color="#ffffff",p.style.fontSize="0.78rem",p.style.fontWeight="700",p.style.letterSpacing="0.08em",p.style.textTransform="uppercase",p.textContent=g?"Scenario Error Slide":`Scenario Scene ${Math.min(u+1,o.length)} / ${o.length}`,m.appendChild(p);const S=document.createElement("div");S.style.color=g?"#fca5a5":"#9ca3af",S.style.fontSize="0.72rem",S.textContent=g?"Use restart to return to the opening scene.":"Select a dialogue box to progress through the scenario.",m.appendChild(S),_.appendChild(m);const b=document.createElement("div");if(b.style.position="relative",b.style.width="100%",b.style.minHeight="360px",b.style.aspectRatio="16 / 9",b.style.background=f?.imageSrc?`linear-gradient(rgba(0,0,0,0.22), rgba(0,0,0,0.38)), url('${f.imageSrc}') center / cover no-repeat`:g?"linear-gradient(140deg, #200909 0%, #451010 55%, #120404 100%)":"linear-gradient(140deg, #111827 0%, #1f2937 45%, #111111 100%)",b.style.overflow="hidden",!f?.imageSrc){const x=document.createElement("div");x.style.position="absolute",x.style.inset="0",x.style.display="flex",x.style.flexDirection="column",x.style.alignItems="center",x.style.justifyContent="center",x.style.gap="10px",x.style.color=g?"#fca5a5":"#d1d5db",x.style.textAlign="center",x.style.padding="24px";const C=document.createElement("div");C.style.fontSize="1rem",C.style.fontWeight="700",C.textContent=g?"Error scene background missing":"Scenario background missing",x.appendChild(C);const A=document.createElement("div");A.style.fontSize="0.82rem",A.style.maxWidth="360px",A.style.lineHeight="1.55",A.textContent="This scenario still works in preview and SCORM export, but adding a background image will make the interaction feel complete.",x.appendChild(A),b.appendChild(x)}if(g){const x=document.createElement("div");x.style.position="absolute",x.style.inset="0",x.style.background="rgba(127,29,29,0.18)",x.style.pointerEvents="none",b.appendChild(x)}(Array.isArray(f?.dialogues)?f.dialogues:[]).forEach(x=>{const C=(h[x.action]??h.next).interactive,A=document.createElement("button");A.type="button",A.style.position="absolute",A.style.left=`${x.x}%`,A.style.top=`${x.y}%`,A.style.transform="translate(-50%, -50%)",A.style.minWidth="140px",A.style.maxWidth="220px",A.style.padding="12px 14px",A.style.borderRadius="12px",A.style.border="1.5px solid rgba(255,255,255,0.26)",A.style.background="rgba(17,24,39,0.74)",A.style.boxShadow="0 14px 32px rgba(0,0,0,0.24)",A.style.cursor=C?"pointer":"default",A.style.textAlign="left",A.style.backdropFilter="blur(4px)",A.style.opacity=C?"1":"0.94",C||(A.disabled=!0);const w=document.createElement("div");w.style.color="#f3f4f6",w.style.fontSize="0.82rem",w.style.fontWeight="600",w.style.lineHeight="1.45",w.style.whiteSpace="pre-wrap",w.textContent=x.text||"Continue",A.appendChild(w),C&&A.addEventListener("click",()=>{x.action==="error"?u=l.length-1:x.action==="restart"?u=0:u=Math.min(u+1,o.length-1),d()}),b.appendChild(A)}),_.appendChild(b),t.appendChild(_)};d();break}case"tabs":{const s=e.tabs||[];if(s.length===0)break;let a=0;const o=()=>{t.innerHTML="";const c=document.createElement("div");c.style.cssText="display:flex;gap:0.5rem;border-bottom:1px solid #2d2d34;margin-bottom:1rem;overflow-x:auto;padding-bottom:0.5rem;",s.forEach((p,S)=>{const b=document.createElement("button");b.textContent=p.title||`Tab ${S+1}`,b.style.cssText=`padding:0.5rem 1rem;cursor:pointer;font-weight:${S===a?600:400};color:${S===a?"#ef4444":"#a1a1aa"};border:none;background:transparent;border-bottom:${S===a?"2px solid #ef4444":"2px solid transparent"};white-space:nowrap;font-family:inherit;font-size:1rem;`,b.onclick=()=>{a=S,o()},c.appendChild(b)}),t.appendChild(c);const l=document.createElement("div");l.style.cssText="background:#202026;border-radius:8px;padding:1.5rem;border:1px solid #2d2d34;";const u=s[a],h=document.createElement("h3");h.style.cssText="margin:0 0 1rem 0;color:#fafafa;font-size:1.25rem;",h.textContent=u.title,l.appendChild(h);const d=document.createElement("div");if(d.style.cssText="display:flex;gap:1.5rem;flex-direction:column;",u.image){const p=document.createElement("div");p.style.cssText="width:100%;max-width:300px;margin:0 auto;";const S=document.createElement("img");S.src=u.image,S.style.cssText="width:100%;border-radius:8px;object-fit:contain;max-height:200px;",p.appendChild(S),d.appendChild(p)}if(u.content){const p=document.createElement("div");p.style.cssText="line-height:1.6;color:#e4e4e7;",p.innerHTML=u.content,d.appendChild(p)}l.appendChild(d),t.appendChild(l);const f=document.createElement("div");f.style.cssText="display:flex;justify-content:space-between;margin-top:1rem;align-items:center;";const g=document.createElement("button");g.textContent="← Prev",g.disabled=a===0,g.style.cssText=`padding:0.5rem 1rem;border-radius:4px;border:1px solid #2d2d34;background:${a===0?"#18181b":"#202026"};color:${a===0?"#4b5563":"#ef4444"};cursor:${a===0?"not-allowed":"pointer"};font-family:inherit;font-size:0.875rem;`,g.onclick=()=>{a>0&&(a--,o())};const _=document.createElement("div");_.style.cssText="font-size:0.875rem;color:#a1a1aa;",_.textContent=`Slide ${a+1} of ${s.length}`;const m=document.createElement("button");m.textContent="Next →",m.disabled=a===s.length-1,m.style.cssText=`padding:0.5rem 1rem;border-radius:4px;border:1px solid #2d2d34;background:${a===s.length-1?"#18181b":"#202026"};color:${a===s.length-1?"#4b5563":"#ef4444"};cursor:${a===s.length-1?"not-allowed":"pointer"};font-family:inherit;font-size:0.875rem;`,m.onclick=()=>{a<s.length-1&&(a++,o())},f.appendChild(g),f.appendChild(_),f.appendChild(m),t.appendChild(f)};o();break}case"accordion":{const s=e.topics||[];if(s.length===0)break;const a=document.createElement("div");a.style.cssText="display:flex;flex-direction:column;gap:0.75rem;",s.forEach((o,c)=>{const l=document.createElement("div");l.style.cssText="border:1px solid #2d2d34;border-radius:10px;overflow:hidden;background:#202026;";const u=document.createElement("button");u.type="button",u.setAttribute("aria-expanded","false"),u.style.cssText="width:100%;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;border:none;background:#1e1e24;color:#fafafa;cursor:pointer;font:inherit;font-weight:700;font-size:0.95rem;text-align:left;";const h=document.createElement("span");h.textContent=o.title||`Topic ${c+1}`,u.appendChild(h);const d=document.createElement("span");d.textContent="▾",d.style.cssText="font-size:1rem;color:#ef4444;transition:transform 0.18s ease;transform:rotate(0deg);",u.appendChild(d);const f=document.createElement("div");f.style.cssText="display:none;padding:16px;background:#202026;border-top:1px solid #2d2d34;";const g=document.createElement("div");g.style.cssText="display:flex;flex-direction:column;gap:12px;",(o.items||[]).forEach(_=>{if(_.type==="image"&&_.src){const m=document.createElement("div");m.style.cssText="text-align:center;";const p=document.createElement("img");if(p.src=_.src,p.alt=_.alt||"",p.style.cssText="max-width:100%;width:100%;height:auto;max-height:320px;object-fit:contain;border-radius:8px;background:#18181b;",m.appendChild(p),_.caption){const S=document.createElement("div");S.style.cssText="margin-top:8px;font-size:0.82rem;color:#a1a1aa;",S.textContent=_.caption,m.appendChild(S)}g.appendChild(m);return}if(_.type==="text"&&_.value){const m=document.createElement("div");m.className="cf-rt-text",m.style.color="#e4e4e7",m.innerHTML=_.value,g.appendChild(m)}}),f.appendChild(g),u.onclick=()=>{const _=u.getAttribute("aria-expanded")==="true";u.setAttribute("aria-expanded",_?"false":"true"),f.style.display=_?"none":"block",d.style.transform=_?"rotate(0deg)":"rotate(180deg)"},l.appendChild(u),l.appendChild(f),a.appendChild(l)}),t.appendChild(a);break}case"image-stack":{const s=e.slides||[];let a=0;const o={},c=()=>{t.innerHTML="";const l=s[a];if(!l)return;const u=Math.round((a+1)/s.length*100),h=document.createElement("div");h.style.cssText="display:flex;align-items:center;gap:8px;margin-bottom:10px;";const d=document.createElement("span");d.style.cssText="font-size:0.78rem;color:#a3a3a3;white-space:nowrap;",d.textContent=l.type==="quiz"?"🧩 Quiz":`Slide ${a+1} / ${s.length}`;const f=document.createElement("div");f.style.cssText="flex:1;height:4px;border-radius:2px;background:#2a2a2a;overflow:hidden;";const g=document.createElement("div");g.style.cssText=`width:${u}%;height:100%;background:#8B1A1A;transition:width 0.3s;`,f.appendChild(g);const _=document.createElement("span");_.style.cssText="font-size:0.78rem;color:#a3a3a3;",_.textContent=`${u}%`,h.appendChild(d),h.appendChild(f),h.appendChild(_),t.appendChild(h);const m=document.createElement("div");if(m.style.cssText="border-radius:10px;overflow:hidden;border:1px solid #2a2a2a;min-height:160px;background:#111;",l.type==="image"){if(l.imageUrl){const A=document.createElement("img");A.src=l.imageUrl,A.style.cssText="width:100%;max-height:400px;object-fit:cover;display:block;",m.appendChild(A)}if(l.caption){const A=document.createElement("div");A.style.cssText="padding:10px 14px;background:rgba(0,0,0,0.6);color:#d4d4d4;font-size:0.9rem;line-height:1.5;",A.textContent=l.caption,m.appendChild(A)}}else if(l.type==="quiz"){const A=document.createElement("div");A.style.cssText="padding:18px;";const w=document.createElement("p");w.style.cssText="color:#fff;font-weight:600;font-size:1rem;margin:0 0 14px 0;",w.textContent=l.question||"Quiz question",A.appendChild(w);const v=document.createElement("div");(l.options||[]).forEach((X,R)=>{const H=document.createElement("button");H.style.cssText="width:100%;text-align:left;background:#1c1c1c;border:1px solid #404040;color:#d4d4d4;padding:9px 14px;border-radius:6px;cursor:pointer;font-size:0.9rem;margin-bottom:8px;transition:all 0.2s;",H.textContent=X||`Option ${R+1}`,H.onclick=()=>{if(R===l.correctIndex)o[l.id]=!0,H.style.background="#052e16",H.style.borderColor="#166534",H.style.color="#4ade80",v.innerHTML='<div style="margin-top:10px;padding:9px 14px;background:#052e16;border:1px solid #166534;border-radius:6px;color:#4ade80;font-weight:600;font-size:0.88rem;">✅ Correct! You can continue.</div>',C.disabled=!1,C.style.opacity="1",C.style.cursor="pointer",C.style.color="#d4d4d4",C.style.background="#1c1c1c",C.textContent="Next →";else{v.innerHTML=`<div style="margin-top:10px;padding:9px 14px;background:#2a0a0a;border:1px solid #7f1d1d;border-radius:6px;color:#f87171;font-weight:600;font-size:0.88rem;display:flex;align-items:center;justify-content:space-between;">
        ...
        `,t.appendChild(h),requestAnimationFrame(()=>{const d=l.map((g,_)=>t.querySelector(`#fitb-${s}-${_}`)).filter(Boolean),f=t.querySelector(`#fitb-btn-${s}`);d.length&&f&&f.addEventListener("click",()=>{let g=0;d.forEach((b,x)=>{const C=b.value.trim(),A=String(l[x]||"").trim();(e.caseSensitive?C:C.toLowerCase())===(e.caseSensitive?A:A.toLowerCase())&&(g+=1)});const _=l.length||1,m=g/_,p=m===1,S=t.querySelector(`#fb-${s}`);S&&(p?S.innerHTML='<span style="color:#4ade80">✓ Correct!</span>':g>0?S.innerHTML=`<span style="color:#fbbf24">△ ${g} of ${_} correct. You can retry for full marks.</span>`:S.innerHTML='<span style="color:#f87171">✗ Incorrect. Try again.</span>'),p?(d.forEach((b,x)=>{b.disabled=!0,b.style.opacity="0.6",b.value=l[x]||""}),f.disabled=!0,f.textContent="Submitted"):(d.forEach(b=>{b.disabled=!1,b.style.opacity="1"}),f.disabled=!1),this.submitGenericQuiz(s,m)})});break}case"multi_select":{t.className+=" cf-rt-quiz-block";const s=e.id,a=this.state.mandatoryCompleted.includes(s);if(e.mandatory){const f=document.createElement("div");f.id=`mandatory-badge-${s}`,f.style.cssText="font-size:10px;font-weight:700;letter-spacing:0.15em;padding:4px 10px;border-radius:6px;margin-bottom:8px;display:inline-block;",a?(f.textContent="✓ COMPLETED",f.style.background="#052e16",f.style.color="#4ade80",f.style.border="1px solid #166534"):(f.textContent="⚠ MANDATORY — Answer to continue",f.style.background="#2a0a0a",f.style.color="#f87171",f.style.border="1px solid #7f1d1d"),t.appendChild(f)}const o=this.state.quizScores[s],c=o&&o.score>0;let l=e.options.map((f,g)=>`
          <label class="cf-rt-quiz-option" data-quiz-id="${s}" data-option-idx="${g}" ${c?'style="opacity:0.6;cursor:not-allowed;"':""}>
            <input type="checkbox" name="ms-${s}" value="${g}" ${c?"disabled":""} ${c&&e.correctAnswer.includes(g.toString())?"checked":""} />
